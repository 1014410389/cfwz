...
if (!empty($listening)) {
	$url = './rank.php?id_num=' . $id_num . '&listening=' . $listening . '&reading=' . $reading . '&comprehensive=' . $comprehensive . '&writing=' . $writing . '&total=' . $total . '&exam_id=' . $exam_id;
} else {
	$url = './rank.php';
}
?>
